...
class AtreeonPaginatedDataTable extends StatefulWidget {
  ...
  /// particular [AtreeonPaginatedDataTable] widget is created; avoid creating a new
  /// [DataTableSource] with each new instance of the [AtreeonPaginatedDataTable]
  ...
  /// To modify the border or background color of the [AtreeonPaginatedDataTable], use
  ...
  /// [AtreeonPaginatedDataTable] widget itself; it should be reused each time the
  /// [AtreeonPaginatedDataTable] constructor is called.
...
/// Holds the state of a [AtreeonPaginatedDataTable].
///
/// The table can be programmatically paged using the [pageTo] method.
class AtreeonPaginatedDataTableState extends State<AtreeonPaginatedDataTable> {
  ...
  @override
  void didUpdateWidget(AtreeonPaginatedDataTable oldWidget) {
